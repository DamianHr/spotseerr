...
if command -v convert &> /dev/null; then
    ...
    magick -background none icons/broken.svg -resize 48x72 icons/broken.png
    magick -background none icons/icon16.svg -resize 16x16 icons/icon16.png
    magick -background none icons/icon32.svg -resize 32x32 icons/icon32.png
...
# Check if Inkscape is installed
    ...
    echo "Using Inkscape..."
    inkscape -w 48 -h 72 icons/broken.svg -o icons/broken.png
